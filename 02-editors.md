...
>> I already use atom, so I'm using atom. It seems to have similar neat features to other editors. It color codes the code based on the language, whatever the proper term for that is. cmd+/ and cmd+[ are very useful shorcuts common to atom and many other editors. I customized it by installing a few packages like a markdown viewer and pylint.
